...
Funcionalidade: Controlar Estrutura Acadêmica
  ...
  Cenário: Admin tenta criar período letivo com datas sobrepostas
    Dado que já existe um período letivo "2025.1" com início em "01/02/2025" e fim em "30/06/2025"
    Quando eu tento criar um novo período letivo "Semestre de Verão" com início em "01/06/2025" e fim em "31/07/2025"
    Então o sistema deve me impedir com a mensagem "Já existe um período letivo ativo nas datas especificadas"
    E o período letivo "Semestre de Verão" não deve ser criado
