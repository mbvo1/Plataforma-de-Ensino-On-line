...
public class GerenciarUsuariosFeature {
    ...
    public void eu_clico_em(String botao) {
        usuarioService.cadastrarNovoUsuario(this.nome, this.email, "00000000000", "senha123", this.perfil);
    }
    ...
    public void que_ja_existe_um_usuario_com_o_email(String emailExistente) {
        usuarioService.cadastrarNovoUsuario("Professor Existente", emailExistente, "00000000000", "senha123", Perfil.PROFESSOR);
    }
    ...
    public void eu_tento_criar_um_novo_professor_com_o_nome_e_o_email(String nome, String email) {
        ...
        try {
            usuarioService.cadastrarNovoUsuario(nome, email, "00000000000", "senha123", Perfil.PROFESSOR);
